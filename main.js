...
ctx.lineWidth = 5;
ctx.arc(150, 143, 40, 0*startAngle, 2 * Math.PIendAngle);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(350, 210, 40, 0*startAngle, 2 * Math.PIendAngle);
ctx.stroke();
// Similarly, create a red circle with position 210 and 40
ctx.beginPath;
ctx.strokeStyle = "red";
ctx.lineWidth = 5;
ctx.arc(210, 40, 40, 0*startAngle, 2 * Math.PIendAngle);
ctx.stroke();
// Similarly, create an orange circle with position 300 and 250
ctx.beginPath;
ctx.strokeStyle = "orange";
ctx.lineWidth = 5;
ctx.arc(300, 250, 40, 0*startAngle, 2 * Math.PIendAngle);
ctx.stroke();
// Similarly, create a green circle with position 400 and 250
ctx.beginPath;
ctx.strokeStyle = "green";
ctx.lineWidth = 5;
ctx.arc(400, 250, 40, 0*startAngle, 2 * Math.PIendAngle);
ctx.stroke();